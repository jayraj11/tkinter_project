...
#***************************************************************
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_cat.get()=="Select" or self.var_cat.get()=="Empty" or self.var_cat.get()=="Select" or self.var_sup.get()=="Select" or self.var_name.get()=="":
...
#***************update*************                       
    def update(self):
        ...
        try:
            if self.var_pid.get()=="":
                messagebox.showerror("Error","Please select from list",parent=self.root)
            else:
    ...
    def delete(self):
        ...
        try:
            if self.var_pid.get()=="":
                ...
                cur.execute("select * from employee where pid=%s",(self.var_pid.get(),))
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Invalid product",parent=self.root)
                else:
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get()=="Select":
                ...
                messagebox.showerror("Error","Enter a search input",parent=self.root)
            else:
